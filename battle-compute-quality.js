(function(root){'use strict';
 ...
 function resolve(value,mobile=!!root.matchMedia?.('(pointer: coarse)').matches){const mode=valid(value)==='auto'?(mobile?'light':'full'):valid(value);return {mode,actorHz:{full:0,light:30,minimum:20}[mode],effectHz:{full:0,light:30,minimum:20}[mode]};}
